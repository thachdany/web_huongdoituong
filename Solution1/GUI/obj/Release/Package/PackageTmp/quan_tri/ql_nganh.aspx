<%@ Page Title="" Language="C#" MasterPageFile="~/quan_tri/Site1.Master" AutoEventWireup="true" CodeBehind="ql_nganh.aspx.cs" Inherits="GUI.quan_tri.ql_nganh" %>
    ...
    <div >
        <form>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox2" runat="server" CssClass="auto-style1" placeholder="Nhập tên bộ môn" Width="249px"></asp:TextBox>
                <br />
                <br />
                <div class="form-group">
                    <asp:Label ID="Label4" runat="server" Text="Tên Ngành"></asp:Label>
                    <asp:TextBox ID="TextBox3" runat="server" CssClass="auto-style1" placeholder="Nhập tên bộ môn" Width="242px" style="margin-top: 0"></asp:TextBox>
                    <br />
                </div>
                 <div class="form-group">
                    <asp:Label ID="Label5" runat="server" Text="Tên Bộ Môn"></asp:Label>
