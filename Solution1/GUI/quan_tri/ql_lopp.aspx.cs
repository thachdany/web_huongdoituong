...
{
    public partial class ql_lopp : System.Web.UI.Page
    {
        ...
        public void hienthi()
        {
            ...
            var query = (from s in db.tlb_lops
                         join c in db.tlb_nganhs on s.ma_nganh equals c.ma_nganh
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            bool kq = xl.xoa_lop(TextBox1.Text, TextBox2.Text, DropDownList1.SelectedItem.Value);
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            bool kq = xl.update_lop(TextBox1.Text, TextBox2.Text, DropDownList1.SelectedItem.Value);
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            ...
            dgvdiemhk1.DataSource = xl.Search_lop(TextBox5.Text);
            dgvdiemhk1.DataBind();
        }
        ...
        protected void dgvdiemhk1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string ma = xl.timnganh_by_ten(HttpUtility.HtmlDecode(gr.Cells[2].Text));
